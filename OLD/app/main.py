...
# REM: 既存ルーター一括登録
from OLD.app.routes import router as api_router
app.include_router(api_router)

# REM: プロンプト配信用エンドポイント登録
from OLD.app.routes.ingest_api import router as ingest_api_router
from OLD.app.routes.metrics import router as metrics_router
from OLD.app.routes.try_ocr import router as try_ocr_router
from OLD.app.routes.dict_editor import router as dict_editor_router
from OLD.app.routes.ocr_api import router as ocr_api_router
