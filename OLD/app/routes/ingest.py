...
# REM: ── プロジェクト共通 ───────────────────────────────
from OLD.src.config import EMBEDDING_OPTIONS, DEVELOPMENT_MODE, OLLAMA_MODEL, DEBUG_MODE
from OLD.db.handler import reset_dev_database
import logging

# REM: ── サービス層 ───────────────────────────────────
from OLD.app.services.ingest.worker import process_file
from OLD.app.services.ocr import OCREngineFactory
from OLD.app.services.ingest import IngestSettingsManager
