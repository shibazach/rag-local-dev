...
from OLD.src.config import DB_ENGINE, EMBEDDING_OPTIONS, OLLAMA_MODEL

# REM: ── プロジェクト内 ───────────────────────────────
from OLD.app.main import templates
from OLD.llm.prompt_loader import list_prompt_keys
