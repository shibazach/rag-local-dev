...
from OLD.db.handler import fetch_top_chunks, fetch_top_files
from OLD.src.config import EMBEDDING_OPTIONS, DEFAULT_EMBEDDING_OPTION
...
def get_embedding_model(model_key: str):
    ...
    if config["embedder"] == "SentenceTransformer":
        ...
        from OLD.src.config import OLLAMA_BASE
