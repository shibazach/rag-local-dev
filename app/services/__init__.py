...
# from .admin_service import AdminService, get_admin_service  # SQLAlchemy依存のため一時的にコメントアウト
...
__all__ = [
    ...
    # 'AdminService',  # SQLAlchemy依存のため一時的にコメントアウト
    # 'get_admin_service'  # SQLAlchemy依存のため一時的にコメントアウト
]